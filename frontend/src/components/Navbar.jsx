            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center h-16">
                    ...
                    <div className="cursor-pointer" onClick={() => window.location.hash = '#home'}>
                        <span className="font-bold text-xl text-blue-600 tracking-tight">Team ToDo</span>
                    </div>
                    ...
                    <div className="flex-1 flex justify-center px-4 lg:ml-6 lg:justify-end relative" ref={searchRef}>
                        <div className="max-w-lg w-full lg:max-w-xs relative group">
                            ...
                            <input
                                ...
                                className="block w-full pl-10 pr-10 py-2 border border-gray-200 rounded-full leading-5 bg-gray-50 placeholder-gray-400 focus:outline-none focus:bg-white focus:ring-2 focus:ring-blue-100 focus:border-blue-400 sm:text-sm transition-all"
                            ...
                            {showResults && (
                                <div className="absolute top-full left-0 mt-2 w-full bg-white rounded-xl shadow-xl border border-gray-100 overflow-hidden z-50 animate-in fade-in zoom-in-95 duration-200">
                                    {isLoading ? (
                                            ...
                                            {results.map((user) => (
                                                <li key={user.id}>
                                                    <button
                                                        ...
                                                        className="w-full text-left px-4 py-3 hover:bg-gray-50 flex items-center gap-3 transition-colors group/item"
                                                    >
